...
public class CampaignPage extends BaseTest {
	...
	public void testCPG_1() {
		...
		String sqlQuery = "select page_url from izmoweb_r1v2.idw_dealer_webpages where  page_type='CAMP' and fk_dealer_id="
	...
	public void testCPG_2() {
		...
		Assert.assertEquals(actual, true, " Campaign Page is Loading on FrontEnd ");
	}
	@Test(priority=3)
	public void testCPG_3() {
